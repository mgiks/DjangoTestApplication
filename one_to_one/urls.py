...
from .views import HouseListView, FamilyListView, HouseCreateView, FamilyCreateView, FamilyReadUpdateDeleteView, HouseReadUpdateDeleteView
...
urlpatterns = [
    ...
    path("families/<int:pk>/", FamilyReadUpdateDeleteView.as_view(), name="family_details"),
]